          ...
          <CardContent className="flex flex-col md:flex-row items-center p-0">
            ...
            <div className="md:w-1/2">
              <Card className={darkMode ? 'bg-gray-800 border-gray-700' : ''}>
                <CardHeader>
                  <CardTitle className={darkMode ? 'text-white' : ''}>Current Weather</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="flex justify-around">
                    <div className="text-center">
                      <Thermometer className="h-8 w-8 mx-auto text-red-500" />
                      <p className={`mt-2 ${darkMode ? 'text-gray-300' : ''}`}>{currentWeather.temp}°C</p>
                    </div>
                    <div className="text-center">
                      <Droplet className="h-8 w-8 mx-auto text-blue-500" />
                      <p className={`mt-2 ${darkMode ? 'text-gray-300' : ''}`}>{currentWeather.humidity}%</p>
                    </div>
                    <div className="text-center">
                      <Wind className="h-8 w-8 mx-auto text-green-500" />
                      <p className={`mt-2 ${darkMode ? 'text-gray-300' : ''}`}>{currentWeather.windSpeed} m/s</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
